...
with open('resourse/original.bin', 'wb') as file:
    file.write(test_bytes)

encrypt('resourse/original.bin', 'resourse/encrypted.bin', 42)
decrypt('resourse/encrypted.bin', 'resourse/decrypted.bin', 42)

with open('resourse/original.bin', 'rb') as file_1:
    orig = file_1.read()
with open('resourse/decrypted.bin', 'rb') as file_2:
    dec = file_2.read()
